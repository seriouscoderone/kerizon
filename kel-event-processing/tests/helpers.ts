...
/** SHA-256 hash function suitable for use as cesr-ts HashFn in tests. */
export function testHashFn(data: Uint8Array): Uint8Array {
  // For tests we need a sync hash. Use a simple deterministic XOR-hash
  // for test stability, or a sync wrapper around crypto.subtle.
  // In reality, builders use saidify which needs a sync HashFn.
  // We use a simplistic approach for test determinism.
